...
<div id="footer">
        ...
        <div class="support-block">
                ...
                <a href="<?php echo $GLOBALS['wasd_domain']; ?>/support" class="button">ЗАДАТЬ ВОПРОС</a>
...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter31103709 = new Ya.Metrika({
                    id:31103709,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/31103709" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
